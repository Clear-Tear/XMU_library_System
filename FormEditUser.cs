...
namespace MyLibrary
{
    public partial class FormEditUser : Form
    {
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            sql = "update userinfo set user_cardno='"+cardno+ "',user_username='" + name+ "',user_department='" + depa+ "',user_tel='" + tel+ "',user_vocation='" + voc+ "',user_availnumber=" + avi+ ",user_sex='" + sex + "' where user_cardno='" + oldcardno+"'";
